-- MySQL query to delete all options created by the ManageWP plugin.
--
...
-- 1. Delete Options
-- This finds and removes all options that begin with 'mwp_', which are typically settings.
DELETE FROM `wp_options` WHERE `option_name` LIKE 'mwp_%';
